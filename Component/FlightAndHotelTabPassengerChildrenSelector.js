...
function FlightAndHotelTabPassengerChildrenSelector(props) {
    ...
    const handleClick = (event, room) => {
        handleClose(event)
        props.handleChildrenChange(event, room)
    };
...
export default FlightAndHotelTabPassengerChildrenSelector;